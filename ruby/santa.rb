class Santa
#added getter and setter shortcuts
  attr_reader :age, :ethnicity
  attr_accessor :gender, :age
#Initializing new instances with a rand function on age
  ...
  #Get_mad method sending the reindeer name fed through to the last of the array
  def get_mad_at(reindeer_name)
    reindeer_rankings.delete(reindeer_name)
    reindeer_rankings << reindeer_name
  end
  
#Code below removed because of attr_accessor  
...
#Added counter to differentiate between the instances
santa_id = 1
